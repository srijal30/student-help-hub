    ...
    return (
        ...
        from-green-800 p-6 items-center flex-grow-0 h-15 flex-col sm:flex-row">
            ...
            <div className="flex text-white items-center">
                ...
                onClick={()=>{localStorage.removeItem('token'); props.setLoggedIn(false); props.setPage('SignIn');}}>Sign Out</button> :
                <React.Fragment>
                    <button className="px-5 py-2 font-semibold hover:text-gray-300"
                    onClick={()=>props.setPage('SignIn')}>Sign In</button>
                    <button className="bg-green-800 px-5 py-2 rounded-lg text-white 
